    ...
    <div className="min-h-full"> {/* Layout handled by PublicLayout */}
      ...
      <header className="relative pt-20 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight tracking-tight animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          ...
          <p className="text-lg text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in zoom-in-95 duration-700 delay-300">
            <Link to="/login" className="w-full sm:w-auto px-8 py-4 bg-white text-ops-bg font-bold rounded-lg hover:bg-blue-50 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-2">
              <span>Launch Dashboard</span>
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </Link>
            <Link to="/demo" className="w-full sm:w-auto px-8 py-4 bg-ops-panel border border-ops-border text-white font-bold rounded-lg hover:border-ops-accent transition-colors flex items-center justify-center gap-2 hover:bg-ops-panel/80">
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link to="/how-it-works" className="group relative bg-ops-panel/50 border border-ops-border rounded-2xl p-8 hover:border-ops-accent transition-all duration-300 overflow-hidden">
             ...
             <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors">How It Works</h3>
          ...
          <Link to="/tutorial" className="group relative bg-ops-panel/50 border border-ops-border rounded-2xl p-8 hover:border-ops-accent transition-all duration-300 overflow-hidden">
             ...
             <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-purple-400 transition-colors">Tutorial</h3>
             <p className="text-slate-400 mb-6 leading-relaxed">
          ...
          <Link to="/faq" className="group relative bg-ops-panel/50 border border-ops-border rounded-2xl p-8 hover:border-ops-accent transition-all duration-300 overflow-hidden">
             ...
             <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-emerald-400 transition-colors">FAQ</h3>
             <p className="text-slate-400 mb-6 leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-b from-ops-bg to-slate-900 border-t border-ops-border">
        <div className="max-w-4xl mx-auto text-center px-6">
          <h2 className="text-3xl font-bold text-white mb-6">Ready to automate your maintenance?</h2>
